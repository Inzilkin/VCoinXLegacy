# VCoinX legacy OLD
VCoinX legacy OLD - старая модификация для [VCoin](https://github.com/xTCry/VCoin), в которой вырезаны пожертвования и комиссии от платежей, а так-же она имеет несколько своих плюшек.

Ветка `legacy` создана для тех, у кого по каким-либо причинам не работает `master` ветка.
